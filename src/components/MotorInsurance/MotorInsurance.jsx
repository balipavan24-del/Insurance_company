...
import motorHeroImage from '../../assets/Motor-Hero.png';
...
const MOTOR_OFFERINGS_TABS = [
  {
    ...
    iconVariant: 'car',
    description:
      'Car insurance protects your car against accidents, damages, and theft. It also covers third-party liabilities as per legal requirements. This ensures financial protection for both your vehicle and others on the road. It is essential for safe and responsible driving.'
  },
  {
    id: 'motor-bike',
    ...
    iconVariant: 'bike',
    description:
      'Bike insurance covers two-wheelers against accidents, theft, and damages. It provides financial protection for repairs and third-party liabilities. This is important for everyday riders and long-distance travelers. It ensures peace of mind on every ride.'
  },
  {
                ...
                <div className="motor-hero-inner">
                  ...
                  <div className="motor-hero-block">
                    ...
                    <div className="motor-image-placeholder">
                      <img
                        src={motorHeroImage}
                        alt="Motor insurance protection for car, bike and commercial vehicle"
