...
const businessHomeFireDetailImage = `${import.meta.env.BASE_URL}images/Business-fire.png`;
...
const businessHomeTheftDetailImage = `${import.meta.env.BASE_URL}images/Business-theft.png`;
const businessHomeNaturalDetailImage = `${import.meta.env.BASE_URL}images/Business-Natural.png`;
const businessHomeEquipmentDetailImage = `${import.meta.env.BASE_URL}images/Business-Equipment.png`;
...
function BusinessHome({
  ...
  return (
    <main className="business-page page-section page-section--hero">
      <section className="business-wrap page-section-container">
      ...
      <section className="business-coverage-section page-section page-section--spacious" aria-label="Business coverage options">
      ...
      <section className="business-home-whats-covered" aria-label="What's covered">
        <div className="business-coverage-wrap page-section-container">
          ...
          >
            ...
            {BUSINESS_HOME_DETAIL_PANELS.map((panel) => (
              <InsuranceDetailPanel key={panel.id} {...panel} />
            ))}
          </div>
        </div>
      </section>
