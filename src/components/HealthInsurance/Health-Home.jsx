...
import { healthInsuranceFaqItems } from '../../config/insurance/productContent';
import { sanitizePhoneNumber, validateHealthContactDetails } from '../../utils/leadValidation';

const healthImage = (name) => `${import.meta.env.BASE_URL}images/health/${name}`;
const healthHeroImage = healthImage('hero.png');
const healthAboutImage = healthImage('About-Health.png');
const healthMattersImage = healthImage('matters.png');
