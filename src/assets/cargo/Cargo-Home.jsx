...
import cargoHomeImage from '../images/CargoHome.webp';
import Footer from '../layout/Footer';
import InsuranceFaqAccordion from '../shared/InsuranceFaqAccordion';
import { cargoInsuranceFaqItems } from '../../productContent';
...
function CargoHome({ onBackHome, onMarineCargoSelect, onAirCargoSelect, onInlandCargoSelect }) {
  const handleMarineCargoClick = () => {
    if (onMarineCargoSelect) {
      onMarineCargoSelect();
      return;
    }
    console.log('Marine cargo selected');
  };
  ...
  const handleAirCargoClick = () => {
    ...
    console.log('Air cargo insurance selected');
  };

  const handleInlandTransitClick = () => {
    if (onInlandCargoSelect) {
      onInlandCargoSelect();
      return;
    }
    console.log('Inland transit insurance selected');
  };
