...
const RENEW_BENEFITS = [
  ...
  },
  {
    ...
    description: 'Expired policies may require commercial vehicle inspections before activation.',
    image: avoidInspectionDelays,
  },
  {
    id: 'legal-compliance',
    title: 'Legal Compliance',
    description: 'Third-party insurance is mandatory for commercial vehicle owners.',
  ...
  },
  {
    id: 'peace-of-mind',
    title: 'Peace of Mind',
    description: 'Operate confidently knowing your commercial fleet remains protected.',
    image: peaceOfMind,
  },
];
...
const RENEW_STEPS = [
  {
    ...
    description: 'Share your commercial vehicle number and basic info.',
...
const RENEW_PRICING_FACTORS = [
  ...
  { id: 'commercial-vehicle-model', label: 'Commercial vehicle model', icon: 'car' },
...
const RENEW_PLAN_TYPES = [
  ...
  },
  {
    ...
    description: 'Protects your own commercial vehicle against damages.',
    tone: 'amber',
...
function CommercialVehicleRenew() {
  ...
  const scrollToRenewForm = () => {
    ...
    const input = document.getElementById('commercial-vehicle-reg-no');
    ...
    <div className="renew-plans-page renew-plans-page--commercial-vehicle">
      ...
      <section className="car-renew-hero page-section page-section--regular page-section-container" aria-labelledby="commercial-vehicle-renew-heading">
        <div className="car-renew-hero__layout">
          ...
          <aside id="commercial-vehicle-renew-form" className="car-renew-form-card" aria-label="Commercial vehicle renewal form">
            <span className="car-renew-form-card__chip">Renew in under 2 minutes</span>
            <h2 className="car-renew-form-card__title">
              <span className="car-renew-form-card__title-line">Renew Your Commercial</span>
              <span className="car-renew-form-card__title-line">Vehicle Insurance</span>
            </h2>
            ...
            <button
              ...
              onClick={() => setIsWithoutCommercialVehicleNumberOpen(true)}
            >
              Continue Without Commercial Vehicle Number
            </button>
            ...
            <ul className="car-renew-form-card__highlights" aria-label="Commercial vehicle renewal highlights">
      ...
      <section className="car-renew-overview page-section page-section--regular page-section-container" aria-labelledby="car-renew-overview-heading">
        <div className="car-renew-overview__layout">
          ...
          <article className="car-renew-overview__card">
            Commercial vehicle insurance renewal is the process of extending your existing truck, van,
            or fleet insurance policy before or after its expiry date to maintain uninterrupted
      ...
      <section className="car-renew-benefits page-section page-section--regular page-section-container" aria-labelledby="car-renew-benefits-heading">
        <div className="car-renew-benefits__inner">
          ...
          <p className="car-renew-benefits__subtitle">
            Timely renewal protects your business, your fleet, and your peace of mind.
          </p>
      ...
      <section className="car-renew-plan-types page-section page-section--regular page-section-container" aria-labelledby="car-renew-plan-types-heading">
        <div className="car-renew-plan-types__inner">
          ...
          <h2 id="car-renew-plan-types-heading" className="car-renew-plan-types__title">
            Types of <span className="car-renew-plan-types__title-accent">Commercial Vehicle Insurance</span>
          </h2>
      ...
      <InsuranceFaqAccordion
        title={commercialVehicleRenewFaqSection.title}
        subtitle={commercialVehicleRenewFaqSection.subtitle}
        items={commercialVehicleRenewFaqItems}
        buttonLabel={commercialVehicleRenewFaqSection.buttonLabel}
      />
        ...
        <div className="car-renew-support__inner">
          <div className="car-renew-support__banner">
            <h2 id="car-renew-support-heading" className="car-renew-support__title">
              {commercialVehicleRenewSupportCard.title}
            </h2>
            <p className="car-renew-support__subtitle">{commercialVehicleRenewSupportCard.subtitle}</p>
            <div className="car-renew-support__actions">
              <button type="button" className="car-renew-support__btn car-renew-support__btn--primary" onClick={scrollToRenewForm}>
                {commercialVehicleRenewSupportCard.primaryCta}
              ...
              >
                {commercialVehicleRenewSupportCard.secondaryCta}
              </button>
            </div>
          </div>
        </div>
      ...
      <AnimatedModal
        isOpen={isWithoutCommercialVehicleNumberOpen}
        onClose={() => setIsWithoutCommercialVehicleNumberOpen(false)}
        overlayClassName="car-renew-without-number-overlay"
        panelClassName="car-renew-without-number-modal"
        ariaLabelledby="commercial-vehicle-renew-without-number-title"
      >
        {({ requestClose }) => (
          <>
            <header className="car-renew-without-number-modal__header">
              <div>
                <h3 id="commercial-vehicle-renew-without-number-title">Continue without commercial vehicle number</h3>
...
export default CommercialVehicleRenew;
