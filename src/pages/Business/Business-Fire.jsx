...
const businessFireDetailImage = `${import.meta.env.BASE_URL}images/Business-fire.webp`;
        ...
        <div className="business-fire-hero">
          ...
          <section className="business-fire-layout">
            ...
            <aside className="business-fire-form-card" aria-label="Fire insurance quote form">
              ...
              <button type="button" className="business-fire-submit" onClick={handleSubmit}>
      ...
      {isSuccessOpen && (
        ...
        >
          <section
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="business-fire-success-title"
          ...
          >
            <div className="business-popup-success">
              ...
              <h3 id="business-fire-success-title" className="business-popup-success__title">
                Request Received
              </h3>
